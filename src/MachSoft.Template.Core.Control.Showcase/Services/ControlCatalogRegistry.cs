...
public static class ControlCatalogRegistry
{
    ...
    [
        ...
        new("display", "Display", "Representación visual de estado, métricas y contenido contextual.", "Planned (Core.Control)", "Tag/status/stats/empty state aún no publicados en Core.Control", "/families/display"),
